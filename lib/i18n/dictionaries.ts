...
const pt: Dict = {
  ...
  gallery: {
    ...
    stacks: {
      ...
      twilio: {
        ...
        title: "Twilio",
        description: "ConversationRelay nativo — o agente atende e liga por telefone a sério.",
  ...
  hume: {
    ...
    descBold: "o Agente de Voz 24/7",
    descMiddle:
      ", bilingue (PT/EN). Uma demo real de automação por IA construída por",
    descEnd: ".",
  ...
  widgets: {
    ...
    hume: {
      callButton: "Falar com o agente",
      requestingMic: "A pedir microfone…",
      disconnecting: "A desligar…",
      retry: "Tentar novamente",
      speaking: "O agente está a falar…",
      listening: "À escuta…",
      errors: {
    ...
    elevenlabs: {
      ...
      ending: "A terminar…",
      listening: "O agente está a ouvir…",
      inputPlaceholder: "Escreve uma mensagem…",
      inputPlaceholderDisabled: "Liga primeiro para escrever ao agente",
      send: "Enviar",
    },
    vapi: { callButton: "Falar com o agente", ending: "A terminar…", listening: "O agente está a ouvir…", unavailable: "Indisponível — em breve" },
    retell: { callButton: "Falar com o agente", ending: "A terminar…", listening: "O agente está a ouvir…", unavailable: "Indisponível — em breve" },
    twilio: { callButton: "Ligar ao agente", ending: "A terminar…", listening: "O agente está a ouvir…", unavailable: "Indisponível — em breve" },
    callMe: {
      heading: "Preferes receber a chamada?",
      description: "Indica o teu número e o agente liga-te em segundos.",
      placeholder: "+351 912 345 678",
      button: "Liga-me",
      calling: "A ligar...",
      success: "O agente está a ligar-te agora!",
...
const en: Dict = {
  ...
  gallery: {
    ...
    stacks: {
      ...
      twilio: { badge: "Telephony · Twilio", title: "Twilio", description: "Native ConversationRelay — the agent answers and dials over a real phone line.", powered: "Twilio ConversationRelay · Claude · ElevenLabs" },
    },
  },
  hume: {
    badge: "Live Demo · Available Now",
    ...
    descBold: "the 24/7 Voice Agent",
    descMiddle:
      ", bilingual (PT / EN). A real-world demo of AI automation built by",
    descEnd: ".",
  ...
  widgets: {
    ...
    elevenlabs: {
      ...
      inputPlaceholderDisabled: "Connect first to chat with the agent",
      send: "Send",
    },
    vapi: { callButton: "Talk to the agent", ending: "Ending…", listening: "The agent is listening…", unavailable: "Unavailable — coming soon" },
    retell: { callButton: "Talk to the agent", ending: "Ending…", listening: "The agent is listening…", unavailable: "Unavailable — coming soon" },
    twilio: { callButton: "Call the agent", ending: "Ending…", listening: "The agent is listening…", unavailable: "Unavailable — coming soon" },
    callMe: {
      heading: "Prefer to receive the call?",
      description: "Enter your number and the agent will call you in seconds.",
      placeholder: "+1 555 123 4567",
      button: "Call Me",
      calling: "Calling...",
      success: "The agent is calling you now!",
